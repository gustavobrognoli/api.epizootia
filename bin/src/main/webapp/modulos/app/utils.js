angular.module("vigilantos").factory("utils", function($http, $window){
	...
	return{
        ...
        formatUtils:{
    		...
    		isVazioNullUndefined : function (valor){
    			if(valor === undefined
    					|| valor === null
    					|| valor === ""
    					|| valor === "null"	) {
        	...
        	}, disableTextAngular : function() {
        		//Fundo desabilitado para text area, apenas layout
        		angular.element('[id^="taTextElement"]').css("background-color","#eee");
        	}
    	}, usuario: {
    		roleName: function(roles, modulo) {
    			if(!roles) {
    				return null;
    			}
